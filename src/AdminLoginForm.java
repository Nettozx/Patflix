...
public class AdminLoginForm extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		out.println("<h3 class=\"uk-panel-title\">Patflix Admin</h3>");
		...
		out.println("<form class=\"uk-form\" data-uk-margin action=\"AdminLoginForm\" method =\"POST\">");
