...
public class Search extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			out.println("Sort by: ");
			out.print(" <a class=\"uk-button\" href=\"Search?by=title&amp;movie="
					+ movie
			...
			if (movieResult.first() == false)
				...
				do {
					...
					//TOOLTIP
					out.println("<div id=\"moviett\" class=\"tipContent\">");
					out.println("<ul class=\"tipContentList\">");
					out.println("    <li><div id=\"moviepop\"></div></li>");
					out.println("</ul>");
					out.println("</div>");
					//END TOOLTIP
					...
					out.print("<button class=\"uk-icon-button uk-icon-info showTip moviett\" "
							+ "onmouseover=\"moviePop("+movieResult.getInt(1)+");\"> </button>");
					out.println("<BR>");
					...
					out.println("    <hr class=\"uk-article-divider\">");
					out.println("</article>");
				...
				out.println("<BR>");
				// rpp modifier
				out.println("| <a href=\"Search?by=title&amp;movie="
						+ movie
						+ "&amp;order=title&amp;type=asc&amp;page=0&amp;rpp=5\">5</a> |");
				out.print("| <a href=\"Search?by=title&amp;movie="
						+ movie
