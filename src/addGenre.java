...
public class addGenre extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		out.println("<h4 class=\"tm-article-subtitle\">New Genre Form</h4>");
		out.println("");
		out.println("                            <form class=\"uk-form uk-form-horizontal\" action=\"addGenreSubmit\" method=\"POST\">");
		out.println("");
		out.println("                                <div class=\"uk-form-row\">");
		out.println("                                    <label class=\"uk-form-label\" for=\"g_id\">Genre ID</label>");
		out.println("                                    <div class=\"uk-form-controls\">");
		out.println("                                        <input type=\"text\" NAME=\"g_id\" id=\"g_id\" placeholder=\"000000\" required>");
		out.println("                                    </div>");
		out.println("                                </div>");
		out.println("                                <div class=\"uk-form-row\">");
		out.println("                                    <label class=\"uk-form-label\" for=\"name\">Genre Name</label>");
		out.println("                                    <div class=\"uk-form-controls\">");
		out.println("                                        <input type=\"text\" NAME=\"name\" id=\"name\" placeholder=\"Action\" required>");
		out.println("                                    </div>");
		...
		try {
			...
			out.println("  <button type=\"submit\" class=\"uk-button\">Add Genre</button>");
			out.println("                            </form>");
			out.println("                                </div>");
			out.println("    </div>");
			out.println("  </div>");
